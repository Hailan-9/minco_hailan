...
public:
        ...
        : nh(nh_)
    {
        ...
        bsPub = nh.advertise<std_msgs::Float64MultiArray>("/visualizer/bs", 1);
        asPub = nh.advertise<std_msgs::Float64MultiArray>("/visualizer/as", 1);
        sPub = nh.advertise<std_msgs::Float64MultiArray>("/visualizer/s", 1);
        accxPub = nh.advertise<std_msgs::Float64MultiArray>("/visualizer/accx", 1);
        accyPub = nh.advertise<std_msgs::Float64MultiArray>("/visualizer/accy", 1);
        vPub = nh.advertise<std_msgs::Float64MultiArray>("/visualizer/v", 1);
    }
    inline void pubVectorXd(const Eigen::VectorXd &v, const std::string &topic)
    {
        uint s = v.size();
        ...
        msg.data = vec;
        dim_msg.size = s;
        msg.layout.dim.push_back(dim_msg);
        ...
        if (topic == "bs")
            ...
            std::cout << "[visualizer] pubVectorXd: no such topic" << std::endl;
    }
